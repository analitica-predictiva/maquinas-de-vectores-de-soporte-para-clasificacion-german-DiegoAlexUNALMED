...
def pregunta_01():
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/analitica-predictiva/maquinas-de-vectores-de-soporte-para-clasificacion-german-DiegoAlexUNALMED/main/german.csv")
